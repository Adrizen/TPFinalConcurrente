...
/*
    ...
    colores de cada print. (se puede resaltar/seleccionar el nombre de un pasajero particular para que sea "highlighted" y seguir su progreso
...
/*
    ...
    allí a un puesto de atención según su aerolinea (hay tantos puestos de atención como aerolineas. 
    Es decir que si hay 'n' aerolineas, hay 'n' puestos de atención).
    ...
    En el aeropuerto hay un tren interno que traslada los pasajeros a la terminal que le corresponde a cada uno. El tren se va vaciando a medida que para 
    en las terminales y va dejando pasajeros, cuando para en la última terminal (la C) vuelve al inicio del recorrido. El tren sale de nuevo una vez que 
    se llena por completo nuevamente.
    ...
    Las aerolineas se generan de manera aleatoria (como dice el enunciado) de entre todas las aerolineas que hay en el aeropuerto.
        n° aerolínea = n° puesto de atención (Es decir que si por ejemplo un pasajero tiene su vuelo en la aerolínea número 2, entonces el
        puesto de atención que le corresponde ser atendido es el puesto de atención número 2).
    ...
    TrenInterno: ReentrantLock (Se utiliza uno por terminal (A, B y C) y su función es la de mantener los pasajeros en espera mientras viajan con
    el tren interno, luego se van liberando a medida que el tren para en las estaciones a dejar los pasajeros).
